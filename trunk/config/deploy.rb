...
role  :web, "bbleague.hawks.org.uk"
role  :app, "bbleague.hawks.org.uk"
role  :db,  "bbleague.hawks.org.uk", :primary => true
...
set :deploy_to,  "/home/.lime/kosmas/sites/bball/bbleague.hawks.org.uk"
set :use_sudo, false
set :checkout, "export"
set :svn, "/usr/bin/svn"
set :svn_user, 'kosmas'
set :svn_password, 'kalathosfaira'
set :repository,
    Proc.new { "--username #{svn_user} " +
               "--password #{svn_password} " +
               "http://svn.mach7x.com/bball_league"}
# =============================================================================
# SSH OPTIONS
# =============================================================================
